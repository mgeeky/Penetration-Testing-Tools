...
- **`Handy-BloodHound-Cypher-Queries.md`** - A list of Bloodhound Cypher queries that I came up with during my various Active Directory security assessments (a list also includes some of my colleagues queries). [gist](https://gist.github.com/mgeeky/3ce3b12189a6b7ee3c092df61de6bb47)
